...
class River:
    ...
    def check_ages(self):
        """allows us to kill animals that are old."""
        ages_fish: list[Fish] = []
    ...
    def view_river(self):
        """allows us to see how river is doing!"""
    ...
    def one_river_week(self) -> None:
        """allows us to run simulation for one week!"""
        idx: int = 1
        while idx <= 7:
            self.one_river_day()
            idx += 1
